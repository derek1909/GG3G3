...
def generate_spike_trains(M=20, N=400, T=100, mmin=25, mmax =75, rmin=1,rmax=10, smin=10,smax = 30, bmin=0.1, bmax = 1):
    """
    ...
    print("params: (m,r,beta,sigma) = ", (m,r,b,s))
...
def fano_classifier(data_points):
    """
